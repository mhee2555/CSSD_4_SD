...
public class SendSterile_washDoclist_Adapter extends ArrayAdapter {
    ...
    public SendSterile_washDoclist_Adapter(AppCompatActivity aActivity, ArrayList<pCustomer> listData,String B_ID) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View v = inflater.inflate(R.layout.list_send_sterile_wash_doclist_adapter, parent, false);
