...
public class Sticker_Indicator_DoubleLayer_Cerulean_50x70 {
    ...
    public Sticker_Indicator_DoubleLayer_Cerulean_50x70(Context context, String IP, List<ModelWashDetailForPrint> Data){
        this.IP = IP;
